...
- `raw/CNAE_Subclasses_2_3_Estrutura_Detalhada.xlsx` — **NÃO commitado** (gitignored). Baixar manualmente
...
```bash
# 1) Baixar XLSX atualizado para backend/data/cnae_2.3/raw/CNAE_Subclasses_2_3_Estrutura_Detalhada.xlsx
# 2) Parsear:
